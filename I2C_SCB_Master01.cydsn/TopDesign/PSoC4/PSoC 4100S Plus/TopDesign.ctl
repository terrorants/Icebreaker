...
-- === CAPSENCE LEDs ===
attribute port_location of REPLACE_WITH_ACTUAL_PIN_NAME(0) : label is "PORT(2,2)"; -- SLIDER 0 GREEN LED
...
attribute port_location of LED_SUCCESS(0) : label is "PORT(5,5)"; -- BUTTON 1 GREEN LED
attribute port_location of REPLACE_WITH_ACTUAL_PIN_NAME(0) : label is "PORT(5,2)"; -- BUTTON 0 GREEN LED

-- === USER LED ===
attribute port_location of LED_ERROR(0) : label is "PORT(3,4)"; -- USER BLUE LED
