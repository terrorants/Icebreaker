// ======================================================================
// Icebreaker.v generated from TopDesign.cysch
// 11/27/2018 at 02:19
...
// TCPWM_P4_v2_10(Clock_CheckTolerance=true, Clock_desired_freq=12, Clock_desired_freq_unit=6, Clock_divisor=1, Clock_FractDividerDenominator=0, Clock_FractDividerNumerator=0, Clock_FractDividerUsed=false, Clock_is_direct=false, Clock_is_divider=false, Clock_is_freq=true, Clock_minus_tolerance=5, Clock_ph_align_clock_id=, Clock_ph_align_clock_name=, Clock_plus_tolerance=5, Clock_source_clock_id=, Clock_source_clock_name=, PinVisibility_index=false, PinVisibility_kill=false, PinVisibility_phiA=false, PinVisibility_phiB=false, PinVisibility_switch=false, PWMCompare=65535, PWMCompareBuf=65535, PWMCompareSwap=0, PWMCountMode=3, PWMCountPresent=false, PWMDeadTimeCycle=0, PWMInterruptMask=1, PWMKillEvent=0, PWMLinenSignal=0, PWMLineSignal=0, PWMMode=4, PWMPeriod=65535, PWMPeriodBuf=65535, PWMPeriodSwap=0, PWMPrescaler=0, PWMReloadMode=0, PWMReloadPresent=false, PWMRunMode=0, PWMSetAlign=0, PWMStartMode=0, PWMStartPresent=false, PWMStopEvent=0, PWMStopMode=0, PWMStopPresent=false, PWMSwitchMode=0, PWMSwitchPresent=false, QuadAutoStart=false, QuadEncodingModes=0, QuadIndexMode=0, QuadIndexPresent=false, QuadInterruptMask=1, QuadPhiAMode=3, QuadPhiBMode=3, QuadStopMode=0, QuadStopPresent=false, TCCaptureMode=0, TCCapturePresent=false, TCCompare=65535, TCCompareBuf=65535, TCCompareSwap=0, TCCompCapMode=2, TCCountingModes=0, TCCountMode=0, TCCountPresent=true, TCInterruptMask=1, TCPeriod=143, TCPrescaler=0, TCPWMCapturePresent=false, TCPWMConfig=1, TCPWMCountPresent=false, TCPWMReloadPresent=false, TCPWMStartPresent=false, TCPWMStopPresent=false, TCReloadMode=0, TCReloadPresent=false, TCRunMode=0, TCStartMode=0, TCStartPresent=false, TCStopMode=0, TCStopPresent=false, TermMode_capture=0, TermMode_cc=0, TermMode_clock=0, TermMode_count=0, TermMode_interrupt=0, TermMode_line=0, TermMode_line_n=0, TermMode_ov=0, TermMode_reload=0, TermMode_start=0, TermMode_stop=0, TermMode_un=0, TermModeStates=, TermVisibility_capture=false, TermVisibility_cc=true, TermVisibility_clock=true, TermVisibility_count=true, TermVisibility_interrupt=true, TermVisibility_line=false, TermVisibility_line_n=false, TermVisibility_ov=true, TermVisibility_reload=false, TermVisibility_start=false, TermVisibility_stop=false, TermVisibility_un=true, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=TCPWM_P4_v2_10, CY_CONFIG_TITLE=ByteCounter_Rx, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=ByteCounter_Rx, CY_INSTANCE_SHORT_NAME=ByteCounter_Rx, CY_MAJOR_VERSION=2, CY_MINOR_VERSION=10, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.2, INSTANCE_NAME=ByteCounter_Rx, )
...
module top ;
    ...
    I2S_v2_70_1 I2S (
        ...
        .sdo(Net_4031[0:0]),
        .rx_dma0(Rx_DMA_tr),
        .rx_dma1(Net_4615[0:0]),
        .tx_dma0(Tx_DMA_tr),
        .tx_dma1(Net_4616[0:0]),
        .rx_interrupt(Net_4617),
        .tx_interrupt(Net_4618),
        .clip(Net_4619[0:0]));

	wire [0:0] tmpOE__Codec_MCLK_net;
	wire [0:0] tmpFB_0__Codec_MCLK_net;
	wire [0:0] tmpIO_0__Codec_MCLK_net;
	wire [0:0] tmpINTERRUPT_0__Codec_MCLK_net;
	electrical [0:0] tmpSIOVREF__Codec_MCLK_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("8843558f-8028-4242-b419-20e93446a62f"),
		  ...
		  .input_buffer_sel(2'b00))
		Codec_MCLK
		 (.oe(tmpOE__Codec_MCLK_net),
		  .y({Net_3641}),
		  .fb({tmpFB_0__Codec_MCLK_net[0:0]}),
		  .io({tmpIO_0__Codec_MCLK_net[0:0]}),
		  .siovref(tmpSIOVREF__Codec_MCLK_net),
		  .interrupt({tmpINTERRUPT_0__Codec_MCLK_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Codec_MCLK_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

    // -- TFF Start --
    reg  cy_tff_2;
    always @(posedge Net_3641)
    begin
        cy_tff_2 <= Net_4620^Clk_I2S;
    end
    assign Clk_I2S = cy_tff_2;
    // -- TFF End --

    // -- TFF Start --
    reg  cy_tff_1;
    always @(posedge Net_3651)
    begin
        cy_tff_1 <= Net_4621^Net_3641;
    end
    assign Net_3641 = cy_tff_1;
    // -- TFF End --

    ZeroTerminal ZeroTerminal_2 (
        .z(Net_4622));

    Timer_v2_80_2 Async_Feedback_Counter (
        .reset(Net_4622),
        .interrupt(Net_4623),
        .enable(1'b1),
        .trigger(1'b1),
        .capture(1'b0),
        .capture_out(Net_4627),
        .tc(Net_4628),
        .clock(I2S_LRCLK));
    defparam Async_Feedback_Counter.CaptureCount = 2;
    defparam Async_Feedback_Counter.CaptureCounterEnabled = 0;
    defparam Async_Feedback_Counter.DeviceFamily = "PSoC4";
    defparam Async_Feedback_Counter.InterruptOnCapture = 0;
    defparam Async_Feedback_Counter.InterruptOnTC = 0;
    defparam Async_Feedback_Counter.Resolution = 8;
    defparam Async_Feedback_Counter.SiliconRevision = "0";
	...
	wire [0:0] tmpOE__Codec_DACDAT_net;
	wire [0:0] tmpFB_0__Codec_DACDAT_net;
	wire [0:0] tmpIO_0__Codec_DACDAT_net;
	wire [0:0] tmpINTERRUPT_0__Codec_DACDAT_net;
	electrical [0:0] tmpSIOVREF__Codec_DACDAT_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("f7d2f3aa-d23d-4113-af4d-7ad57d266155"),
		  ...
		  .input_buffer_sel(2'b00))
		Codec_DACDAT
		 (.oe(tmpOE__Codec_DACDAT_net),
		  .y({Net_4031[0:0]}),
		  .fb({tmpFB_0__Codec_DACDAT_net[0:0]}),
		  .io({tmpIO_0__Codec_DACDAT_net[0:0]}),
		  .siovref(tmpSIOVREF__Codec_DACDAT_net),
		  .interrupt({tmpINTERRUPT_0__Codec_DACDAT_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Codec_DACDAT_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Codec_BCLK_net;
	wire [0:0] tmpFB_0__Codec_BCLK_net;
	wire [0:0] tmpIO_0__Codec_BCLK_net;
	wire [0:0] tmpINTERRUPT_0__Codec_BCLK_net;
	electrical [0:0] tmpSIOVREF__Codec_BCLK_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("f110f600-1aee-49c0-bbad-738496221ccc"),
		  ...
		  .input_buffer_sel(2'b00))
		Codec_BCLK
		 (.oe(tmpOE__Codec_BCLK_net),
		  .y({Net_4032}),
		  .fb({tmpFB_0__Codec_BCLK_net[0:0]}),
		  .io({tmpIO_0__Codec_BCLK_net[0:0]}),
		  .siovref(tmpSIOVREF__Codec_BCLK_net),
		  .interrupt({tmpINTERRUPT_0__Codec_BCLK_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Codec_BCLK_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Codec_LRC_net;
	wire [0:0] tmpFB_0__Codec_LRC_net;
	wire [0:0] tmpIO_0__Codec_LRC_net;
	wire [0:0] tmpINTERRUPT_0__Codec_LRC_net;
	electrical [0:0] tmpSIOVREF__Codec_LRC_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("2e1e8d66-1e7e-4cfe-bf79-eae640f97731"),
		  ...
		  .input_buffer_sel(2'b00))
		Codec_LRC
		 (.oe(tmpOE__Codec_LRC_net),
		  .y({I2S_LRCLK}),
		  .fb({tmpFB_0__Codec_LRC_net[0:0]}),
		  .io({tmpIO_0__Codec_LRC_net[0:0]}),
		  .siovref(tmpSIOVREF__Codec_LRC_net),
		  .interrupt({tmpINTERRUPT_0__Codec_LRC_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Codec_LRC_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Codec_ADCDAT_net;
	wire [0:0] tmpIO_0__Codec_ADCDAT_net;
	wire [0:0] tmpINTERRUPT_0__Codec_ADCDAT_net;
	electrical [0:0] tmpSIOVREF__Codec_ADCDAT_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("de616092-3627-4d1c-9049-719cec881e0a"),
		  ...
		  .input_buffer_sel(2'b00))
		Codec_ADCDAT
		 (.oe(tmpOE__Codec_ADCDAT_net),
		  .y({1'b0}),
		  .fb({Net_4030}),
		  .io({tmpIO_0__Codec_ADCDAT_net[0:0]}),
		  .siovref(tmpSIOVREF__Codec_ADCDAT_net),
		  .interrupt({tmpINTERRUPT_0__Codec_ADCDAT_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Codec_ADCDAT_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

    TCPWM_P4_v2_10_3 ByteCounter_Tx (
        .stop(1'b0),
        .reload(1'b0),
        .start(1'b0),
        .count(TxCount),
    ...
    TCPWM_P4_v2_10_4 ByteCounter_Rx (
        .stop(1'b0),
        .reload(1'b0),
        .start(1'b0),
        .count(RxCount),
    ...
    if (1)
    begin : AudioClkMux
        reg  tmp__AudioClkMux_reg;
        always @(Net_4312 or Net_3667 or Net_3792)
        begin
            case (Net_3792)
                1'b0 :  tmp__AudioClkMux_reg = Net_4312;
                1'b1 :  tmp__AudioClkMux_reg = Net_3667;
            endcase
        end
        assign Net_3651 = tmp__AudioClkMux_reg;
    end
    // -- Mux end --

    CyControlReg_v1_80 AudioClkSel (
        .control_1(Net_4698),
        .control_2(Net_4699),
        .control_3(Net_4700),
        .control_0(Net_3792),
        ...
        .clock(1'b0),
        .reset(1'b0));
    defparam AudioClkSel.Bit0Mode = 0;
    defparam AudioClkSel.Bit1Mode = 0;
    defparam AudioClkSel.Bit2Mode = 0;
    defparam AudioClkSel.Bit3Mode = 0;
    defparam AudioClkSel.Bit4Mode = 0;
    defparam AudioClkSel.Bit5Mode = 0;
    defparam AudioClkSel.Bit6Mode = 0;
    defparam AudioClkSel.Bit7Mode = 0;
    defparam AudioClkSel.BitValue = 0;
    defparam AudioClkSel.BusDisplay = 0;
    defparam AudioClkSel.ExtrReset = 0;
    defparam AudioClkSel.NumOutputs = 1;
