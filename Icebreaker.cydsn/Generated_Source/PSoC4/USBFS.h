...
#define USBFS_INTR_LVL_SEL                     (0x04200028u)
...
#define USBFS_DEVICE0_CONFIGURATION0_INTERFACE3_ALTERNATE0_HID_IN_BUF_SIZE (2u)
...
#define USBFS_HID_RPT_1_SIZE_LSB               (0x23u)
