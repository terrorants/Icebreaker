...
#define CapSense_LEFT__BTN        (1u)
#define CapSense_RIGHT__BTN        (2u)
#define CapSense_UP__BTN        (3u)
#define CapSense_DOWN__BTN        (4u)
#define CapSense_CENTRE__BTN        (5u)
...
#define CapSense_POS_FILTERS_MASK                    (0x1u)
#define CapSense_LINEAR_SLIDERS_POS_FILTERS_MASK     (0x0u)
#define CapSense_RADIAL_SLIDERS_POS_FILTERS_MASK     (0x1u)
...
#define CapSense_END_OF_BUTTONS_INDEX                (5u)
#define CapSense_END_OF_MATRIX_BUTTONS_INDEX         (5u)
#define CapSense_END_OF_WIDGETS_INDEX                (6u)
