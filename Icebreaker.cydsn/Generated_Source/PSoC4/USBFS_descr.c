...
* Config Descriptor  
*********************************************************************/
const uint8 CYCODE USBFS_DEVICE0_CONFIGURATION0_DESCR[231u] = {
/*  Config Descriptor Length               */ 0x09u,
/*  DescriptorType: CONFIG                 */ 0x02u,
/*  wTotalLength                           */ 0xE7u, 0x00u,
...
/* DescriptorType: STRING                  */ 0x03u,
 ...
 (uint8)'r', 0u,
/*********************************************************************
* String Descriptor: "CY8CKIT-046 USB Audio"
*********************************************************************/
/* Descriptor Length                       */ 0x2Cu,
/* DescriptorType: STRING                  */ 0x03u,
...
*********************************************************************/
const uint8 CYCODE USBFS_HIDREPORT_DESCRIPTOR1[39u] = {
...
const T_USBFS_LUT CYCODE USBFS_DEVICE0_CONFIGURATION0_INTERFACE3_ALTERNATE0_HID_TABLE[5u] = {
    ...
    {0x01u,     (const void *)&USBFS_DEVICE0_CONFIGURATION0_DESCR[215]}
};
...
{0x01u, 0x01u, 0x01u, 0x05u, 0x0126u,   0x01u},
{0x01u, 0x01u, 0x83u, 0x11u, 0x0003u,   0x01u},
{0x02u, 0x01u, 0x82u, 0x05u, 0x0126u,   0x01u},
